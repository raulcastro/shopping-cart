...
ALTER TABLE app_info ADD COLUMN lang VARCHAR(2) NULL;
ALTER TABLE app_info ADD COLUMN googleplus VARCHAR(256) NULL;
ALTER TABLE app_info ADD COLUMN pinterest VARCHAR(256) NULL;
ALTER TABLE app_info ADD COLUMN linkedin VARCHAR(256) NULL;
ALTER TABLE app_info ADD COLUMN email VARCHAR(256) NULL;
